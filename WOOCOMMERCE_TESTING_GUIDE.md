...
- [ ] Хлебные крошки используют `dsa_breadcrumbs()`
- [ ] Директории созданы
- [ ] Базовые страницы WooCommerce работают
...
- [ ] Создано 15+ тестовых товаров с ACF полями
- [ ] Каталог отображается с группировкой
- [ ] Табличный вид работает
- [ ] Карточный вид работает
- [ ] Переключение видов сохраняется в Cookie
- [ ] Фильтры раскрываются/скрываются
- [ ] Фильтрация работает
