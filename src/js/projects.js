...
class ProjectsPage {
    ...
    initElements() {
        ...
        this.paginationButtons = document.querySelectorAll('.projects-pagination__page');
        this.perPageButtons = document.querySelectorAll('.projects-pagination__per-page-btn');
        this.prevButton = document.querySelector('.projects-pagination__btn_prev');
        this.nextButton = document.querySelector('.projects-pagination__btn_next');
        this.projectsGrid = document.querySelector('.projects-grid__items');
        this.paginationControls = document.querySelector('.projects-pagination__controls');
    ...
    changePerPage(perPage) {
        // Убираем активный класс с всех кнопок
        this.perPageButtons.forEach(btn => btn.classList.remove('projects-pagination__per-page-btn_active'));
        ...
        if (activeButton) {
            activeButton.classList.add('projects-pagination__per-page-btn_active');
        }
    ...
    updatePaginationDisplay() {
        const pagesContainer = document.querySelector('.projects-pagination__pages');
        ...
        if (this.totalPages <= 1) {
            ...
            const navContainer = document.querySelector('.projects-pagination__nav');
            if (navContainer) {
                const pagesContainer = navContainer.querySelector('.projects-pagination__pages');
                const btnContainer = navContainer.querySelector('.projects-pagination__btn');
    ...
    createPageButton(container, pageNumber) {
        ...
        button.className = 'projects-pagination__page';
        button.textContent = pageNumber;
        button.dataset.page = pageNumber;

        if (pageNumber === this.currentPage) {
            button.classList.add('projects-pagination__page_active');
        }
    ...
    createDotsButton(container) {
        ...
        dots.className = 'projects-pagination__dots';
        dots.textContent = '...';
    ...
    updateResultsInfo() {
        ...
        resultsInfo.className = 'projects-pagination__results';
        resultsInfo.innerHTML = `
            <span class="projects-pagination__results-text">
