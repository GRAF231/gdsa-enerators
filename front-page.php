            ...
            <div class="home-slider__container">
                ...
                <div class="home-slider__content">
                    <div class="home-slider__slides-container">
                        <?php 
                        // Получаем слайды из ACF или используем дефолтные значения
                        ...
                        ?>
                        <div class="home-slider__slide <?php echo $active_class; ?>">
                            <div class="home-slider__text">
                                <h1 class="home-slider__title"><?php echo esc_html(get_sub_field('title')); ?></h1>
                                <?php if (get_sub_field('subtitle')) : ?>
                                <p class="home-slider__subtitle"><?php echo esc_html(get_sub_field('subtitle')); ?></p>
                                <?php endif; ?>
                                <div class="home-slider__divider"></div>
                            </div>
                            <div class="home-slider__image">
                                <img src="<?php echo esc_url(get_sub_field('image')); ?>" alt="<?php echo esc_attr(get_sub_field('title')); ?>" class="home-slider__img">
                            </div>
                        </div>
                        <?php 
                            endwhile;
                        ...
                        <div class="home-slider__indicators">
                            <?php 
                            // Генерируем индикаторы на основе количества слайдов
                            if (have_rows('home_slider_slides')) :
                                $slide_count = count(get_field('home_slider_slides'));
                                for ($i = 1; $i <= $slide_count; $i++) :
                                    $active_indicator = ($i === 1) ? 'active' : '';
                            ?>
                            <button class="home-slider__indicator <?php echo $active_indicator; ?>" aria-label="Слайд <?php echo $i; ?>"></button>
                            <?php 
                                endfor;
                            else : 
                            ?>
                    ...
                    <div class="home-slider__filters">
                        ...
                        <div class="home-slider__power-grid">
                            ...
                            if (have_rows('home_slider_power_buttons')) :
                                while (have_rows('home_slider_power_buttons')) : the_row();
                                    $power = get_sub_field('power');
                                    $url = get_sub_field('url') ?: '/catalog?power=' . $power;
                            ?>
                            <a href="<?php echo esc_url($url); ?>" class="home-slider__power-btn"><?php echo esc_html($power); ?> кВт</a>
                            <?php 
                                endwhile;
                            else : 
                                // Дефолтные кнопки мощности
                            ?>
        ...
        <section class="section home-catalog">
            <div class="home-catalog__container">
                ...
                <div class="home-catalog__grid">
                    <?php 
                    // Получаем категории каталога из ACF или используем дефолтные значения
                    if (have_rows('home_catalog_items')) :
                        while (have_rows('home_catalog_items')) : the_row();
                    ?>
                    <a href="<?php echo esc_url(get_sub_field('url')); ?>" class="home-catalog__item">
                        <div class="home-catalog__item-image">
                            <img src="<?php echo esc_url(get_sub_field('image')); ?>" alt="<?php echo esc_attr(get_sub_field('title')); ?>" class="home-catalog__img">
                        </div>
                        <div class="home-catalog__item-content">
                            <h3 class="home-catalog__item-title"><?php echo esc_html(get_sub_field('title')); ?></h3>
                            <?php if (get_sub_field('description')) : ?>
                            <p class="home-catalog__item-description"><?php echo esc_html(get_sub_field('description')); ?></p>
                            <?php endif; ?>
        ...
        <section class="section home-advantages">
            <div class="home-advantages__container">
                ...
                <div class="home-advantages__grid">
                    <?php 
                    if (have_rows('home_advantages_items')) :
                        while (have_rows('home_advantages_items')) : the_row();
                    ?>
                    <div class="home-advantages__item">
                        <div class="home-advantages__icon">
                            <i class="<?php echo esc_attr(get_sub_field('icon')); ?>"></i>
                        </div>
                        <h3 class="home-advantages__item-title"><?php echo esc_html(get_sub_field('title')); ?></h3>
                        <p class="home-advantages__item-description"><?php echo esc_html(get_sub_field('description')); ?></p>
                    </div>
                    <?php endwhile; else : ?>
                    <div class="home-advantages__item">
                        <div class="home-advantages__icon">
        ...
        <section class="section home-equipment">
            <div class="home-equipment__container">
                ...
                <div class="home-equipment__row">
                    <?php 
                    if (have_rows('home_equipment_items')) :
                        while (have_rows('home_equipment_items')) : the_row();
                    ?>
                    <a href="<?php echo esc_url(get_sub_field('url')); ?>" class="home-equipment__item">
                        <div class="home-equipment__item-image">
                            <img src="<?php echo esc_url(get_sub_field('image')); ?>" alt="<?php echo esc_attr(get_sub_field('title')); ?>" class="home-equipment__img">
                        </div>
                        <div class="home-equipment__item-content">
                            <h3 class="home-equipment__item-title"><?php echo esc_html(get_sub_field('title')); ?></h3>
                            <?php if (get_sub_field('subtitle')) : ?>
                            <p class="home-equipment__item-subtitle"><?php echo esc_html(get_sub_field('subtitle')); ?></p>
                            <?php endif; ?>
                        </div>
                    </a>
                    <?php endwhile; else : ?>
                        ...
                        <div class="home-popular__slider-track">
                            ...
                            <a href="<?php echo esc_url($product_url); ?>" class="home-popular__item">
                                ...
                                <div class="home-popular__item-content">
                                    <h4 class="home-popular__item-title"><?php echo esc_html(get_sub_field('title')); ?></h4>
                                    <div class="home-popular__item-specs">
                                        <span class="home-popular__spec">Мощность: <?php echo esc_html(get_sub_field('power')); ?></span>
                                        <span class="home-popular__spec">Топливо: <?php echo esc_html(get_sub_field('fuel')); ?></span>
                                    </div>
        ...
        <section class="section home-projects">
            <div class="home-projects__container">
                ...
                <div class="home-projects__gallery">
                    <?php 
                    if (have_rows('home_projects_items')) :
                        while (have_rows('home_projects_items')) : the_row();
                    ?>
                    <div class="home-projects__project" data-category="<?php echo esc_attr(get_sub_field('category')); ?>">
                        <div class="home-projects__project-image">
                            <img src="<?php echo esc_url(get_sub_field('image')); ?>" alt="<?php echo esc_attr(get_sub_field('title')); ?>" loading="lazy">
                            <div class="home-projects__project-overlay">
                                <div class="home-projects__project-info">
                                    <h3 class="home-projects__project-title"><?php echo esc_html(get_sub_field('title')); ?></h3>
                                    <p class="home-projects__project-desc"><?php echo esc_html(get_sub_field('description')); ?></p>
                                    <div class="home-projects__project-stats">
                                        <span class="home-projects__stat"><?php echo esc_html(get_sub_field('power')); ?></span>
                                        <span class="home-projects__stat"><?php echo esc_html(get_sub_field('year')); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="catalog__content">
                    ...
                    <div class="catalog__panel catalog__panel_active" data-panel="power">
                        <div class="catalog__grid">
                            <?php 
                            if (have_rows('catalog_power_categories')) :
                                while (have_rows('catalog_power_categories')) : the_row();
                            ?>
                            <div class="catalog__category">
                                <h3 class="catalog__category-title"><?php echo esc_html(get_sub_field('title')); ?></h3>
                                <div class="catalog__options">
                                    <?php 
                                    if (have_rows('options')) :
                                        while (have_rows('options')) : the_row();
                                    ?>
                                    <a href="<?php echo esc_url(get_sub_field('url')); ?>" class="catalog__option"><?php echo esc_html(get_sub_field('label')); ?></a>
                                    <?php endwhile; endif; ?>
                                </div>
                            </div>
                            <?php endwhile; else : ?>
                    ...
                    <div class="catalog__panel" data-panel="manufacturer">
                        <div class="catalog__grid">
                            <?php 
                            if (have_rows('catalog_manufacturers')) :
                                while (have_rows('catalog_manufacturers')) : the_row();
                            ?>
                            <div class="catalog__category">
                                <h3 class="catalog__category-title"><?php echo esc_html(get_sub_field('title')); ?></h3>
                                <div class="catalog__options">
                    ...
                    <div class="catalog__panel" data-panel="engine">
                        <div class="catalog__grid">
                            <?php 
                            if (have_rows('catalog_engines')) :
                                while (have_rows('catalog_engines')) : the_row();
                            ?>
                            <div class="catalog__category">
                                <h3 class="catalog__category-title"><?php echo esc_html(get_sub_field('title')); ?></h3>
                                <div class="catalog__options">
